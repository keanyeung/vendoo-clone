...
export const AnalysisSchema = z.object({
  ...
  summary: z
    .string()
    .describe(
      "One concise sentence (under ~20 words) summarizing the item for a marketplace listing: what it is, the brand, and one or two standout attributes. Do not include price, condition, or size — size and condition each get their own line, and price has its own field. Plain text, exactly one sentence.",
    ),
  description: z
    .string()
    .describe(
      "Concise buyer-facing listing description of exactly 2 short sentences and no more than 35 words total. In the first sentence, identify the item, its brand, and its most notable visible features. In the second sentence, add further detail a buyer would care about, such as material, fit, cut, styling, era, or how it wears. Do not mention condition, wear, flaws, or price — the listing prints condition on its own line beneath the description, built from the condition field. Do not invent details that are not visible in the photos. Plain text only, no markdown.",
    ),
  brand: z
    .string()
    .nullable()
