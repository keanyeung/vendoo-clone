...
- Keep the description concise: exactly two short sentences and no more than 35 words total. It describes the item itself — what it is and its notable features — never its condition, since the listing prints condition on its own line beneath the description.
